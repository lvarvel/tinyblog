...
FixtureBuilder.configure do |fbuilder|
  ...
  fbuilder.factory do
    ...
    first = name(:intro, create(:post, title: 'Intro to object oriented INTERCAL', body: "Do you hate programming? You will, after this simple tutorial!", published: true, published_at: Time.now, author: default_user.first))
  end
end
